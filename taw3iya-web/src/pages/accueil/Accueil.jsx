                ...
                <div className="jumbotron monheader">
                    ...
                    <div className="row">
                        <div className="col-md-12 mx-auto d-flex justify-content-center">
                            <Link to="/Nouveaudossier" className="btn btn-primary mx-auto px-5 border border-dark">S'inscrire</Link>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 my-auto">
                ...
                <div className="row">
                    ...
                    <a className="text-start text-white text-decoration-none" href="https://play.google.com/store/apps/details?id=com.sensibilisationapp.com" target="_blank">
